    ...
    <div class="container">
        <div class="row align-items-center mb-4">
            <div class="col-md-7">
                ...
                <p class="lead text-muted">Mọi thắc mắc về sản phẩm, đơn hàng hay hợp tác, vui lòng liên hệ — chúng tôi luôn sẵn sàng hỗ trợ.</p>
            </div>
            ...
            <div class="col-lg-5">
                <div class="card shadow-sm mb-3">
                    <div class="card-body">
                        ...
                        <!-- Replace the src with your Google Maps embed or office location -->
